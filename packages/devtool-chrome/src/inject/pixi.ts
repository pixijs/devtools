...
class PixiWrapper {
   ...
   */
  private _searchIFrames(props: (keyof Window)[]) {
  ...
  public get devtools() {
    ...
    this._devtools = this._searchIFrames(['__PIXI_DEVTOOLS__']) as Devtools;
  ...
  public get app() {
    ...
    this._app = this._searchIFrames(['__PIXI_APP__']) as Application;
    return this._app;
  }
  ...
  public get stage() {
    ...
    this._stage = this._searchIFrames(['__PIXI_STAGE__']) as Container;
    if (this._stage) return this._stage;
  ...
  public get renderer() {
    ...
    this._renderer = this._searchIFrames(['__PIXI_RENDERER__']);
    if (this._renderer) return this._renderer;
  ...
  public get pixi() {
    ...
    this._pixi = this._searchIFrames(['PIXI', '__PIXI__']) as typeof import('pixi.js');
    return this._pixi;
  }
