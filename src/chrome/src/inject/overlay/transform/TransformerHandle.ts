...
export function getHandle() {
  /**
   * The transformer handle base implementation.
   *
   * @extends PIXI.Graphics
   */
  return class TransformerHandle extends getPixiObject('Graphics') {
    ...
    protected onPointerDown(e: FederatedPointerEvent): void {
      ...
      this._pointerMoveTarget = (this.transformer.stage || this) as unknown as Container;
